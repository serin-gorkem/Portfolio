            ...
            <section className="flex flex-col justify-between gap-6 text-text-white sm:gap-9 xl:w-8/12">
              ...
              <div className="relative h-[3.75rem] w-[9.625rem] border-2 border-highlight sm:h-[3.75rem] sm:w-[10.625rem]">
                <Link to="/showcase" className="p-2" state={{ project }}>
                  <button className="h-[3.75rem] w-[9.625rem] -translate-x-4 -translate-y-2 bg-highlight font-lato text-sm font-bold text-white transition-all duration-500 hover:-translate-x-2 hover:-translate-y-[0.13rem] sm:h-[3.75rem] sm:w-[10.625rem] sm:text-base">
                    see this work
                  </button>
                </Link>
              </div>
