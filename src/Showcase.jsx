  ...
  return (
    ...
    <article id="showcase" className="m-2 h-[calc(100vh-1rem)] bg-primary xl:m-4 xl:h-[calc(100vh-2rem)] landscape:max-xl:h-[150vh]">
      ...
      <main  className="relative my-8 flex flex-col items-center justify-center px-2">
        ...
        <p className="text-center animate-fade-in font-lato font-light leading-[175%] tracking-normal sm:text-[1.125rem] sm:leading-[175%] xl:w-[26rem]">
          {project.description}
        </p>
        ...
        <Link smooth to={"#showcase"} aria-label="Go back to top" className="w-full flex justify-end max-container">
          <svg
            width="48px"
            height="48px"
