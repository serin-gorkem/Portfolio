  ...
  return (
    <article className="m-2 h-[calc(100vh-1rem)] bg-primary xl:m-4 xl:h-[calc(100vh-2rem)] landscape:max-xl:h-[150vh]">
      ...
      <main className="relative my-8 flex flex-col items-center justify-center px-2">
        ...
        <p className="text-center font-lato font-light leading-[175%] tracking-normal sm:text-[1.125rem] sm:leading-[175%] xl:w-[46rem]">
        ...
        <div className="relative mb-10 mt-8 h-[3.5rem] w-[9.625rem] animate-fade-in border-2 border-secondary sm:mb-16 sm:h-[3.75rem] sm:w-[10.625rem]">
        ...
        <Suspense fallback={<h1>Loading...</h1>}>{<SiteImage />}</Suspense>
      </main>
      <Link
        smooth
        to={"#top"}
        className="max-container flex w-full justify-end"
      >
        <svg
          width="48px"
          height="48px"
